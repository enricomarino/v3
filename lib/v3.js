 ...
 */
 ...
 !(function (exports) {
  ...
  v3.Program.prototype.bindAttribute = function(context, options) {    
   ...
   * @param {WebGLRenderingContext} context A WebGL rendering context.
   * @param {Array} attributes The attributes to bind.
   * @returns {v3.Program} this Program.
   */

  v3.Program.prototype.bindAttributes = function (context, attributes) {
    attributes.forEach(function (attribute) {
      this.bindAttribute(context, attribute);
    });
    return this;
  };
